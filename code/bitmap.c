...
int main()
{
        ...
        //     {
        //         printf("%d ", pixels[i * width * bytesPerPixel + j]);
        //     }
        //     printf("\n");
        // }
        ...
        // // pixels holds all of our pixel data, this is represented as values from 0 - 15
        // // We can now manipulate the pixel data as we wish
        // // For example, we can invert the colors of the image
        // for (int i = 0; i < height; i++)
        // {
        //     for (int j = 0; j < width * bytesPerPixel; j++)
        //     {
        //         pixels[i * width * bytesPerPixel + j] = 15 - pixels[i * width * bytesPerPixel + j];
        //     }
        // }
